module.exports = [
  ...
  even if you disapprove of their choices. \
  If your child thinks he wants Murderous Bob, \
  the Doll with the Face You Can Rip Right Off, you'd better get it. \
  You may be worried that it might help to encourage your child's antisocial tendencies, \
  ...
  an electrical current developed and the frog's leg kicked, even though it was no longer attached to the frog, \
  which was dead anyway. Galvani's discovery led to enormous advances in the field of amphibian medicine. \
  Today, skilled veterinary surgeons can take a frog that has been seriously injured or killed, \
  ...
  or personal comfort, or any combination of the above, \
  or none of the above, be unilaterally and unequivocally assumed, proclaimed, \
  and adhered to as absolute truth to be undeniably, universally, immutably, and infinitely so, \
  until such time as it becomes advantageous to assume otherwise, maybe."
];